						...
						<?php
							...
							foreach ($getAllCart as  $value) {
								...
								<form action="xulycart.php" method="get">
									<td>'.$i.'</td>
									<td>'.$value['name'].'</td>
									<td><img src="./img/'.$value['image'].'" alt="" style="width: 200px"></td>
									<td><input type="number" name="qty" value="'.$value['qty'].'"></td>
									<td> '.number_format($value['price']).' VNĐ</td>
									<td> '.number_format($value['total']).' VNĐ</td>
									<td><input type="submit" name="delete" value="Xóa" style="background: red; color: #fff;"><input type="submit" name="edit" value="Sửa" style="background: blue; color: #fff;"></td>
