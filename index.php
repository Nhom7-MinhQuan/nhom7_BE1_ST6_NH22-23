		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					<!-- shop -->
					<?php
						$getTop3Protype = $protype->getTop3Protype();
						foreach ($getTop3Protype as $value) {
					?>
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img src="./img/<?php echo $value['type_image']; ?>" alt="" class="img-fluid">
							</div>
							<div class="shop-body">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<?php 
										foreach ($getAllProtype as $value) {
									?>
									<li><a data-toggle="tab" href="#tab2"><?php echo $value['type_name']; ?></a></li>
									<?php
										}
									?>
								</ul>
					...
					<div class="col-md-4 col-xs-6">
						...
						<div class="products-widget-slick" data-nav="#slick-nav-3">
							<div>
								<!-- product widget -->
								<?php
									$getTopSellingOppo = $product->getTopSellingOppo();
									foreach ($getTopSellingOppo as $value) {
								?>
							...
							<div>
								<!-- product widget -->
								<?php
									$getTopSellingOppoNext = $product->getTopSellingOppoNext();
									foreach ($getTopSellingOppoNext as $value) {
								?>
								<div class="product-widget">
									<div class="product-img">
										<img src="./img/<?php echo $value['image'] ?>" alt="">
					...
					<div class="col-md-4 col-xs-6">
						...
						<div class="products-widget-slick" data-nav="#slick-nav-4">
							<div>
								<!-- product widget -->
								<?php
									$getTopSellingApple = $product->getTopSellingApple();
									foreach ($getTopSellingApple as $value) {
								?>
								<div class="product-widget">
									<div class="product-img">
										<img src="./img/<?php echo $value['image'] ?>" alt="">
							...
							<div>
								<!-- product widget -->
								<?php
									$getTopSellingAppleNext = $product->getTopSellingAppleNext();
									foreach ($getTopSellingAppleNext as $value) {
								?>
								<div class="product-widget">
									<div class="product-img">
										<img src="./img/<?php echo $value['image'] ?>" alt="">
					...
					<div class="col-md-4 col-xs-6">
						...
						<div class="products-widget-slick" data-nav="#slick-nav-5">
							<div>
								<!-- product widget -->
								<?php
									$getTopSellingSamsung = $product->getTopSellingSamsung();
									foreach ($getTopSellingSamsung as $value) {
								?>
								<div class="product-widget">
									<div class="product-img">
										<img src="./img/<?php echo $value['image'] ?>" alt="">
							...
							<div>
								<!-- product widget -->
								<?php
									$getTopSellingSamsungNext = $product->getTopSellingSamsungNext();
									foreach ($getTopSellingSamsungNext as $value) {
								?>
								<div class="product-widget">
									<div class="product-img">
										<img src="./img/<?php echo $value['image'] ?>" alt="">
