          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <a class="btn btn-info btn-sm" href="add-manufactures.php">
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td class="project-actions text-right">
                      <a class="btn btn-info btn-sm" href="edit-manufactures.php?id=<?php echo $value['manu_id']?>">
                        <i class="fa fa-pencil-alt"></i>
                        Edit
                      </a>
                      <a class="btn btn-danger btn-sm" href="delmanufactures.php?id=<?php echo $value['manu_id']?>">
