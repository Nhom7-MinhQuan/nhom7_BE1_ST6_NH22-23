      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <form action="xuliaddprotype.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label for="inputName">Protype image</label>
                <input name="image" type="file" id="inputName" class="form-control">
              </div>
              <!-- <div class="form-group">
                <label for="inputDescription">Products description</label>
                <textarea name="description" id="inputDescription" class="form-control" rows="2"></textarea>
              </div>
              <div class="form-group">
                <label for="inputName">Products festure</label>
                <input name="festure" type="checkbox" id="inputName" class="form-control">
              </div> -->
            </div>
            <!-- /.card-body -->
          </div>
