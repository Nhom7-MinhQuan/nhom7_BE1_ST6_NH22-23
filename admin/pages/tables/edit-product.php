      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <form action="xulieditproduct.php" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label for="inputName">Products Name</label>
                <input type="hiden" name="id" value=<?php echo $p[0]['id']?>>
                <input name="name" value="<?php echo $p[0]['name']?>" type="text" id="inputName" class="form-control">
              </div>
              <div class="form-group">
               <label for="inputStatus">Products manu_id</label>
              ...
              <div class="form-group">
                <label for="inputStatus">Products type_id</label>
              ...
              <div class="form-group">
                <label for="inputName">Products price</label>
                <input name="price" value="<?php echo $p[0]['price']?>"  type="text" id="inputName" class="form-control">
              </div>
              <div class="form-group">
                <label for="inputName">Products image</label>
                <input name="image" type="file" id="inputName" class="form-control">
                <img style="width:100px;" src="img/<?php echo $p[0]['image']?>" alt="">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label for="inputName">Products feature</label>
                <?php if($p[0]['feature'] == 1):?>
