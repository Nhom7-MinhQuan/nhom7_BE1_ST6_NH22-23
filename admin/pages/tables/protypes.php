          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <a class="btn btn-info btn-sm" href="add-protype.php">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td>
                      <img style="width:100px" src="img/<?php echo $value['type_image']?>" alt="">
                    </td>
                    <td class="project-actions text-right">
                      <a class="btn btn-info btn-sm" href="edit-protype.php?id=<?php echo $value['type_id']?>">
